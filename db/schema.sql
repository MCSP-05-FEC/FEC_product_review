...
INSERT INTO products(name, product_number, account, rating, comment, image) VALUES ('PS5', 14, 'Draven', 5, 'I cannot wait to get this', 'https://i.pcmag.com/imagery/articles/03DipZNkSAmvNgUZxwrjIkg-7.fit_scale.size_1050x591.v1591972419.jpg');
INSERT INTO products( name, product_number, account, rating, comment, image) VALUES ('Hairbrush', 15, 'shouta', 4, 'This a great brush for the price.', 'https://imgaz.staticbg.com/thumb/large/oaupload/banggood/images/AB/F4/cf30fd23-d705-478b-8d4d-4ea8cf4673fb.jpeg');
INSERT INTO products( name, product_number, account, rating, comment, image) VALUES ('Cantu', 16, 'Living', 5, 'Love the smell of this hair cream and how soft it leaves my hair. It is not sticky and easy to apply.', 'https://target.scene7.com/is/image/Target/GUEST_e42cd755-75d0-4538-ab32-42bbac212606?wid=125&fmt=pjpeg');
INSERT INTO products( name, product_number, account, rating, comment, image) VALUES ('Zippo lighter', 17, 'funkyKS', 5, 'Good lighter. It does what it is supposed to do.', 'https://www.grindworx.com/imgs/shop-by-brand/all-zippo-lighters/Zippo-Lighter-Made-in-USA-flag-high-polished-chrome-BHQ-70920-er-large.jpg' );
INSERT INTO products( name, product_number, account, rating, comment, image) VALUES ('Apple Keyboard', 18, 'tcarlyon21', 4, 'It feels very premium. Comfortable and quick to type on, durable build quality, and long lasting battery. The price is a bit too steep though, and there is no reason why the space gray should be $20 more expensive than the silver keyboard.', 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MLA22LL?wid=1144&hei=1144&fmt=jpeg&qlt=95&op_usm=0.5,0.5&.v=1496944005839' );
INSERT INTO products( name, product_number, account, rating, comment, image) VALUES ('AA batteries', 19, 'Henry', 5, 'Good quality batteries.', 'https://www.staples-3p.com/s7/is/image/Staples/sp90224429_sc7?wid=700&hei=700');
